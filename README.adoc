...
----
oc new-project workshop-infra
oc apply -f https://raw.githubusercontent.com/stakater/workshop-operator/1.0/config/deploy/workshop_operator_deployment.yaml
----
...
There is examples of custom resources (CR) in https://github.com/stakater/openshift-workshop-operator/tree/master/deploy/crds[crds]
...
[source,bash]
----
make docker-build IMG=quay.io/stakater/workshop-operator
make docker-push IMG=quay.io/stakater/workshop-operator
----